...
public class EmailsUtils {
    ...
    public static void sendTestReportEmail(String reportPath){ //Can be called without creating an object
        ...
        //Sender Credentials
        final String senderEmail = "purwanchalcampus8@gmail.com";
        final String appPassword = "rezqmcawtjwehjhg";
        final String recipientEmail = "prasanganiraula2016@gmail.com";
...
//            message.setRecipients(Message.RecipientType.CC, InternetAddress.parse("sandhyagyawali63@gmail.com"));
